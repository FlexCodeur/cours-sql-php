...
<main>
    ...
    <div class="article">
        ...
        <div>
            <!-- update article -->
            <a href="<?php echo HOME_URL . 'views/update_article.php?id=' . $user->id_article; ?>"><i
                    class="fa-solid fa-pencil"></i></a>

            <!-- delete article -->
            <a class="delete_article"
                href="<?php echo HOME_URL . 'requests/delete_article_post.php?id=' . $user->id_article; ?>"><i
    ...
    <div class="comment">
        ...
        <div>
            <!-- update comment -->
            <a href="<?php echo HOME_URL . 'views/comment_update.php?id=' . $user->id_comment; ?>"><i
                    class="fa-solid fa-pencil"></i></a>

            <!-- delete comment -->
            <a class="delete_comment"
                href="<?php echo HOME_URL . 'requests/delete_comment_post.php?id=' . $user->id_comment; ?>"><i
                    class="fa-solid fa-trash-can"></i></a>
        </div>
