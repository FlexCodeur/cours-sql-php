...
if (isset($_SESSION['role_slug'])) $role_slug
?>
...
<main>
    ...
    <article class="article">
        ...
        <div class="article_action">
            <!-- update article -->
            <?php if ($role_slug == "administrator" || ($role_slug == 'editor' && $result->id_user == $_SESSION['id_user'])) : ?>
        ...
        <?php $id_article = $result->id;
			...
			$req = $db->prepare("SELECT 
				c.id, c.comment_content, c.created_at, u.pseudo
                FROM comments c
                INNER JOIN users u
                ON u.id = c.id_user
                WHERE c.id_article = ?
