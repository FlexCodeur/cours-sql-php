			...
			<?php if(isset($_SESSION['id_user']) && $_SESSION['role_slug'] != 'user') : 
				...
				<div class="article_action">
					...
					<?php if($role_slug == 'administrator') : ?>
						<a href="<?php echo HOME_URL . 'requests/delete_article_post.php?id=' . $id_article; ?>"><i class="fa-solid fa-trash-can fa-2x"></i></a>
					<?php endif; ?>					
				</div>
			<?php endif; ?>
...
<div class="pop_delete_article">
	...
	<div class="delete_action_article">
		<div class="delete_article cursor_pointer green">
			<i class="fa-solid fa-circle-check fa-2x"></i>
		</div>
		<div class="return_article cursor_pointer red">
