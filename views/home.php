...
$array = array(
	...
	<a href="<?php echo HOME_URL; ?>requests/request_get.php?variable=99&variable2=Otis&variable3=FERU">Envoi de la requête GET de plusieurs variables</a>
	...
	<?php $comment_id = 2503; ?>
	<a href="<?php echo HOME_URL; ?>requests/request_get.php?comment_id=<?php echo $comment_id; ?>">Effacer le commentaire</a>
	<br>
	<h4>Exercice</h4>
	...
	<h4>Correction</h4>
	<div>
		<a href="<?php echo HOME_URL; ?>requests/request_get.php?display=img">Afficher une image</a>
	</div>
	<div>
		<a href="<?php echo HOME_URL; ?>requests/request_get.php?display=text">Afficher du texte</a>
	</div>
	...
	<form action="<?php echo HOME_URL; ?>requests/request_post.php" method="POST" class="file_form" enctype="multipart/form-data">
		<div>
	...
	<p>Les cookies sont un stockage de variables avec leur valeur dans le client de l'utilisateur. Celle-ci a une durée de validité (en timestamp pour PHP), si aucune durée de cookie est définie, le cookie sera détruit dès que le navigateur sera fermé</p>
	...
	<p>Pour activer la lecture est l'inscription de données, il faudra mettre en session_start() au début de chaque page (si les variables de sessions sont utiles)</p>
